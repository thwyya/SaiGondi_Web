...
const ReviewCard = ({ review }: ReviewCardProps) => {
  ...
  const authorName = (user && (user.name || (user.firstName && `${user.firstName} ${user.lastName}`))) || (review as any).fullName || (review as any).firstName || "Người dùng ẩn danh";
  ...
  return (
    <>
      <div className="flex gap-4">
        ...
        <IoFlagSharp className="cursor-pointer" onClick={() => setReportOpen(true)} />
        {reportOpen && (
